...
Docs: https://mayrajeo.github.io/geo2ml/plotting.html.md"""
...
# %% ../nbs/31_plotting.ipynb #48957121-8209-46a9-8372-26011af28173
...
# %% ../nbs/31_plotting.ipynb #fe973e4f-bcd3-47cd-b09f-5d18870ff58e
...
# %% ../nbs/31_plotting.ipynb #db088f3f-17a1-462c-a45a-9a70a32a9133
def plot_yolo_instance(annotation_fname:Path, image_fname:Path, ax:plt.Axes,
    ...
    if ann_type == 'box':
        ...
        for ann in transformed_annotations:
            ...
            ax.add_patch(mpatches.Rectangle((x0,y0), x1-x0, y1-y0, fill=False, linestyle='--',
                                            linewidth=2, edgecolor=np.array(cmap(obj_cls))))
        ...
        for ann in anns:
            ...
            ax.add_patch(mpatches.Polygon(coords, fill=False, linewidth=1.5, 
