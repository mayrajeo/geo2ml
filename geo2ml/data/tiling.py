...
Docs: https://mayrajeo.github.io/geo2ml/data.tiling.html.md"""
...
# %% ../../nbs/12_data.tiling.ipynb #65f53cca
...
# %% ../../nbs/12_data.tiling.ipynb #9f4dbab3
...
# %% ../../nbs/12_data.tiling.ipynb #5efb54bf
class Tiler():
    """
    ...
    def tile_raster(self, path_to_raster:Path|str, allow_partial_data:bool=False) -> None:
    ...
    def tile_vector(self, path_to_vector:Path|str, min_area_pct:float=0.0, gpkg_layer:str=None, output_format:str='geojson') -> None:
        ...
        if output_format == 'geojson':
            ...
            raise Exception(
                'Unknown output format, must be either `geojson` or `gpkg`'
            )
    ...
    def tile_and_rasterize_vector(self, path_to_raster:Path|str, path_to_vector:Path|str, column:str,
...
# %% ../../nbs/12_data.tiling.ipynb #9c7bde87
def untile_raster(path_to_targets:Path|str, outfile:Path|str, method:str='first'):
...
def untile_vector(path_to_targets:Path|str, outpath:Path|str, non_max_suppression_thresh:float=0.0, nms_criterion:str='score'):
