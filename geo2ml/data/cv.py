...
Docs: https://mayrajeo.github.io/geo2ml/data.cv.html.md"""
...
# %% ../../nbs/13_data.cv.ipynb #8ef4ab33-5fbb-40ae-b2bd-3313c47e9fc6
...
# %% ../../nbs/13_data.cv.ipynb #6b5b21d0-e22c-4c69-9c81-b9951899bd6b
...
# %% ../../nbs/13_data.cv.ipynb #8b3589d9-7ccb-410b-8c2c-186737948a2f
...
# %% ../../nbs/13_data.cv.ipynb #30e91dcf-e8a2-4655-aade-d675444a8386
...
# %% ../../nbs/13_data.cv.ipynb #3c15f36e-63e6-4e5a-a5d6-5f951e3a7def
def shp_to_coco_results(prediction_path:Path, raster_path:Path, coco_dict:Path, outfile:Path, 
    ...
    for i in tqdm(range_of(raster_tiles)):
        ...
        if os.path.isdir(prediction_path): gdf = gpd.read_file(prediction_path/vector_tiles[i])
        elif shp_path.suffix == '.gpkg': gdf = gpd.read_file(prediction_path, layer=layers[i])
        tfmd_gdf = gdf_to_px(gdf, raster_path/raster_tiles[i], precision=3)
        for row in tfmd_gdf.itertuples():
            res = {'image_id': image_id,
                   'category_id': getattr(row, label_col),
                   'segmentation': None,
                   'score': np.round(getattr(row, 'score'), 5) if 'score' in tfmd_gdf.columns else 0.0}
...
# %% ../../nbs/13_data.cv.ipynb #144371b9-5430-44da-8428-2e78897ca6c0
...
# %% ../../nbs/13_data.cv.ipynb #6d689429-ec1e-43c7-bf01-7e4cb6218dd2
